...
export default function RecipeReviewCard(props) {
  ...
  return (
    <Feedcard
      ...
      url={`https://twitter.com/${props.item.handlename.handlename}/status/${props.item.wid}`}
      logo={props.item.logo}
      title={props.item.handlename.handlename}
      handlename={props.item.handlename.handlename}
      date={props.item.published}
      media={props.item.wmedia}
      description={props.item.wtext}
